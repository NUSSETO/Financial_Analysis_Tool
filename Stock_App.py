...
st.markdown("""
            <style>
                ...
                /* General table centering for Module 3 */
                .element-container:has(div[data-testid="stDataFrame"]) table,
                .element-container:has(div[data-testid="stDataEditor"]) table {
                ...
                div[data-testid="stDataFrame"] td > div,
                div[data-testid="stDataFrame"] td > div > div {
                    display: flex !important;
                    justify-content: center !important;
                    align-items: center !important;
                    text-align: center !important;
                }
                /* Target all nested content in DataFrame cells */
                div[data-testid="stDataFrame"] td *,
                ...
                div[data-testid="stDataEditor"] td > div,
                div[data-testid="stDataEditor"] td > div > div {
                    display: flex !important;
                    justify-content: center !important;
                    align-items: center !important;
                    text-align: center !important;
                }
                /* Target all nested content in DataEditor cells */
                div[data-testid="stDataEditor"] td *,
                div[data-testid="stDataEditor"] td[style*="text-align"] {
                    text-align: center !important;
                }
                /* Override any inline styles */
                div[data-testid="stDataEditor"] td[style] {
                    text-align: center !important;
                }
